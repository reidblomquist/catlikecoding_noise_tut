...
public static class Noise {
  ...
  public static NoiseMethod[] perlinMethods =
	...
	*/
	...
	/**********************************************************
	* Perlin NoiseMethod gradient values
	*
	*/
	...
	private static float Dot3 (Vector3 g, float x, float y, float z)
	{
	...
	*/
	...
	public static float Perlin3D(Vector3 point, float frequency)
	{
		...
		float v000 = Dot3(g000, tx0, ty0, tz0);
		float v100 = Dot3(g100, tx1, ty0, tz0);
		float v010 = Dot3(g010, tx0, ty1, tz0);
		float v110 = Dot3(g110, tx1, ty1, tz0);
		float v001 = Dot3(g001, tx0, ty0, tz1);
		float v101 = Dot3(g101, tx1, ty0, tz1);
		float v011 = Dot3(g011, tx0, ty1, tz1);
		float v111 = Dot3(g111, tx1, ty1, tz1);
